 ...
 * @param timelineid   Timeline ID (added for the QoT Stack)
 * @param timelinefd   Timeline file descriptor (added for the QoT Stack)
 * @return             A pointer to the single global clock instance.
 */
struct clock *clock_create(enum clock_type type, struct config *config,
			   const char *phc_device, int timelineid, int *timelinefd);
