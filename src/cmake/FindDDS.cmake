...
find_library(DDS_CORE_LIBRARY OpenDDS_Dcps
    HINTS ${DDS_ROOT}/lib $ENV{DDS_ROOT}/lib)
find_library(DDS_TCP_LIBRARY OpenDDS_Tcp
    HINTS ${DDS_ROOT}/lib $ENV{DDS_ROOT}/lib)
find_library(DDS_REPO_LIBRARY OpenDDS_InfoRepoDiscovery
    HINTS ${DDS_ROOT}/lib $ENV{DDS_ROOT}/lib)
find_library(TAO_CORE_LIBRARY TAO
    HINTS ${ACE_ROOT}/lib $ENV{ACE_ROOT}/lib)
find_library(ACE_CORE_LIBRARY ACE
    HINTS ${ACE_ROOT}/lib $ENV{ACE_ROOT}/lib)
find_library(TAO_SERVER_LIBRARY TAO_PortableServer
    HINTS ${ACE_ROOT}/lib $ENV{ACE_ROOT}/lib)
find_library(TAO_ANY_LIBRARY TAO_AnyTypeCode
    HINTS ${ACE_ROOT}/lib $ENV{ACE_ROOT}/lib)
...
set(DDS_INCLUDE_DIRS ${DDS_INCLUDE_DIR} ${ACE_INCLUDE_DIR} ${TAO_INCLUDE_DIR})
